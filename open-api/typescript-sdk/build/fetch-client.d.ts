 ...
 */
export declare function getSceneData(opts?: Oazapfts.RequestOpts): Promise<SearchExploreResponseDto[]>;
/**
 * Reclassify all assets
 */
export declare function reclassifyAllScenes(opts?: Oazapfts.RequestOpts): Promise<never>;
/**
 * Smart asset search
 */
 ...
 * Get time bucket
 */
export declare function getTimeBucket({ albumId, bbox, isFavorite, isTrashed, key, order, personId, sceneLabel, slug, tagId, timeBucket, userId, visibility, withCoordinates, withPartners, withStacked }: {
    albumId?: string;
    bbox?: string;
    isFavorite?: boolean;
    isTrashed?: boolean;
 ...
 * Get time buckets
 */
export declare function getTimeBuckets({ albumId, bbox, isFavorite, isTrashed, key, order, personId, sceneLabel, slug, tagId, userId, visibility, withCoordinates, withPartners, withStacked }: {
    albumId?: string;
    bbox?: string;
    isFavorite?: boolean;
    isTrashed?: boolean;
