 ...
 */
export function getSceneData(opts) {
    return oazapfts.ok(oazapfts.fetchJson("/search/scenes", {
        ...opts
    }));
}
/**
 ...
 */
export function reclassifyAllScenes(opts) {
 ...
 * Get time bucket
 */
export function getTimeBucket({ albumId, bbox, isFavorite, isTrashed, key, order, personId, sceneLabel, slug, tagId, timeBucket, userId, visibility, withCoordinates, withPartners, withStacked }, opts) {
 ...
 * Get time buckets
 */
export function getTimeBuckets({ albumId, bbox, isFavorite, isTrashed, key, order, personId, sceneLabel, slug, tagId, userId, visibility, withCoordinates, withPartners, withStacked }, opts) {
...
(function (QueueName) {
    ...
    QueueName["Ocr"] = "ocr";
    QueueName["SceneClassification"] = "sceneClassification";
...
(function (JobName) {
    ...
    JobName["Ocr"] = "Ocr";
    JobName["SceneClassificationQueueAll"] = "SceneClassificationQueueAll";
    JobName["SceneClassification"] = "SceneClassification";
